...
import com.example.mebelcart.MebelCartApplication
...
import com.example.mebelcart.util.validateEmail
...
class UserAccountViewModel @Inject constructor(
    ...
    fun updateUser(user: User, imageUri: Uri?){
        var areInputValid = validateEmail(user.email) is RegisterValidation.Success
        ...
        viewModelScope.launch {
            try {
                val imageBitmap = MediaStore.Images.Media.getBitmap(
                    getApplication<MebelCartApplication>().contentResolver,
                    imageUri
                )
